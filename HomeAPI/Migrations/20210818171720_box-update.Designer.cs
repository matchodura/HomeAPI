...
namespace HomeAPI.Migrations
{
    ...
    [Migration("20210818171720_box-update")]
    partial class boxupdate
    {
            ...
            modelBuilder.Entity("HomeAPI.Models.Box", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 18, 19, 17, 19, 427, DateTimeKind.Local).AddTicks(9492),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 18, 19, 17, 19, 430, DateTimeKind.Local).AddTicks(5288),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LightSensorID = 0,
                            MotionSensorId = 0,
                            RoomId = 2
