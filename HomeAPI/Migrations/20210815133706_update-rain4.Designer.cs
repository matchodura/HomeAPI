...
namespace HomeAPI.Migrations
{
    ...
    [Migration("20210815133706_update-rain4")]
    partial class updaterain4
    {
            ...
            modelBuilder.Entity("HomeAPI.Models.Box", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 15, 15, 37, 6, 184, DateTimeKind.Local).AddTicks(9030),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 15, 15, 37, 6, 187, DateTimeKind.Local).AddTicks(2232),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LightSensorID = 0,
                            MotionSensorId = 0,
                            RoomId = 2
