...
namespace HomeAPI.Migrations
{
    ...
    [Migration("20210815120347_update-rain3")]
    partial class updaterain3
    {
            ...
            modelBuilder.Entity("HomeAPI.Models.Box", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 15, 14, 3, 47, 212, DateTimeKind.Local).AddTicks(6695),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Mateusz",
                            DHTId = 0,
                            DateCreated = new DateTime(2021, 8, 15, 14, 3, 47, 215, DateTimeKind.Local).AddTicks(2450),
                            DateModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LightSensorID = 0,
                            MotionSensorId = 0,
                            RoomId = 2
